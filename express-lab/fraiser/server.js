...
app.get('/niles', (req,res) =>{
    res.send("You know, sometimes I wonder if I am not just in psychiatry for the money");
});

app.get("/daphne", (req,res) =>{
    res.send("we'll have fun. i'm off to stick my head in the oven.");
});
...
app.listen(3001, () =>{
console.log('Hello, Seattle. I am listening. . .');
